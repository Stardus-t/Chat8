...
class ChatingReqDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ChatingReq> _instance;
} _ChatingReq_default_instance_;
class ChatingRspDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ChatingRsp> _instance;
} _ChatingRsp_default_instance_;
}  // namespace message
static void InitDefaultsscc_info_ChatingReq_message_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::message::_ChatingReq_default_instance_;
    new (ptr) ::message::ChatingReq();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::message::ChatingReq::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ChatingReq_message_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ChatingReq_message_2eproto}, {}};

static void InitDefaultsscc_info_ChatingRsp_message_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::message::_ChatingRsp_default_instance_;
    new (ptr) ::message::ChatingRsp();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::message::ChatingRsp::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ChatingRsp_message_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ChatingRsp_message_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::message::UserServerRsp, grpc_port_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::message::ChatingReq, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::message::ChatingReq, sender_name_),
  PROTOBUF_FIELD_OFFSET(::message::ChatingReq, sender_uid_),
  PROTOBUF_FIELD_OFFSET(::message::ChatingReq, recv_name_),
  PROTOBUF_FIELD_OFFSET(::message::ChatingReq, recv_uid_),
  PROTOBUF_FIELD_OFFSET(::message::ChatingReq, content_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::message::ChatingRsp, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::message::ChatingRsp, error_),
  PROTOBUF_FIELD_OFFSET(::message::ChatingRsp, error_msg_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 45, -1, sizeof(::message::UserUidReq)},
  { 53, -1, sizeof(::message::UserUidRsp)},
  { 60, -1, sizeof(::message::ChatingReq)},
  { 70, -1, sizeof(::message::ChatingRsp)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::message::_ChatingReq_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::message::_ChatingRsp_default_instance_),
};
...
const char descriptor_table_protodef_message_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "st\030\003 \001(\t\022\014\n\004port\030\004 \001(\t\022\021\n\tgrpc_port\030\005 \001("
  "\t\"D\n\nUserUidReq\022\017\n\007is_chat\030\001 \001(\010\022\022\n\nsend"
  "er_uid\030\002 \001(\t\022\021\n\tuser_name\030\003 \001(\t\"/\n\nUserU"
  "idRsp\022\r\n\005error\030\001 \001(\005\022\022\n\ntarget_uid\030\002 \001(\t"
  "\"k\n\nChatingReq\022\023\n\013sender_name\030\001 \001(\t\022\022\n\ns"
  "ender_uid\030\002 \001(\005\022\021\n\trecv_name\030\003 \001(\t\022\020\n\010re"
  "cv_uid\030\004 \001(\005\022\017\n\007content\030\005 \001(\t\".\n\nChating"
  "Rsp\022\r\n\005error\030\001 \001(\005\022\021\n\terror_msg\030\002 \001(\t2P\n"
  "\rVarifyService\022\?\n\rGetVarifyCode\022\025.messag"
  "e.GetVarifyReq\032\025.message.GetVarifyRsp\"\0002"
  "J\n\013ChatService\022;\n\017GetReplyMessage\022\023.mess"
  "age.ChatingReq\032\023.message.ChatingRsp2\321\001\n\r"
  "StatusService\022G\n\rGetChatServer\022\031.message"
  ".GetChatServerReq\032\031.message.GetChatServe"
  "rRsp\"\000\022\?\n\rGetUserServer\022\026.message.UserSe"
  "rverReq\032\026.message.UserServerRsp\0226\n\nGetUs"
  "erUid\022\023.message.UserUidReq\032\023.message.Use"
  "rUidRsp2\317\001\n\013GateService\022G\n\rGetChatServer"
  "\022\031.message.GetChatServerReq\032\031.message.Ge"
  "tChatServerRsp\"\000\022\?\n\rGetUserServer\022\026.mess"
  "age.UserServerReq\032\026.message.UserServerRs"
  "p\0226\n\nGetUseruid\022\023.message.UserUidReq\032\023.m"
  "essage.UserUidRspb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_message_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_message_2eproto_sccs[10] = {
  &scc_info_ChatingReq_message_2eproto.base,
  &scc_info_ChatingRsp_message_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_message_2eproto = {
  false, false, descriptor_table_protodef_message_2eproto, "message.proto", 1225,
...
UserServerRsp::UserServerRsp(const UserServerRsp& from)
  ...
  grpc_port_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_grpc_port().empty()) {
    grpc_port_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_grpc_port(),
      GetArena());
  }
  error_ = from.error_;
...
void UserServerRsp::SharedDtor() {
  ...
  host_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  port_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  grpc_port_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "message.UserServerRsp.grpc_port"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* UserServerRsp::_InternalSerialize(
  ...
  // string grpc_port = 5;
  if (this->grpc_port().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_grpc_port().data(), static_cast<int>(this->_internal_grpc_port().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "message.UserServerRsp.grpc_port");
    target = stream->WriteStringMaybeAliased(
        5, this->_internal_grpc_port(), target);
  }
...
void UserServerRsp::InternalSwap(UserServerRsp* other) {
  ...
  host_.Swap(&other->host_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  port_.Swap(&other->port_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  grpc_port_.Swap(&other->grpc_port_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  swap(error_, other->error_);
}
...
void ChatingReq::InitAsDefaultInstance() {
}
class ChatingReq::_Internal {
 public:
};

ChatingReq::ChatingReq(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:message.ChatingReq)
}
ChatingReq::ChatingReq(const ChatingReq& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ...
  recv_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_recv_name().empty()) {
    recv_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_recv_name(),
      GetArena());
  }
  ...
  ::memcpy(&sender_uid_, &from.sender_uid_,
    static_cast<size_t>(reinterpret_cast<char*>(&recv_uid_) -
    reinterpret_cast<char*>(&sender_uid_)) + sizeof(recv_uid_));
  // @@protoc_insertion_point(copy_constructor:message.ChatingReq)
}

void ChatingReq::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ChatingReq_message_2eproto.base);
  sender_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  recv_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  content_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ::memset(&sender_uid_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&recv_uid_) -
      reinterpret_cast<char*>(&sender_uid_)) + sizeof(recv_uid_));
}

ChatingReq::~ChatingReq() {
  // @@protoc_insertion_point(destructor:message.ChatingReq)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void ChatingReq::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  sender_name_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  recv_name_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  content_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void ChatingReq::ArenaDtor(void* object) {
  ChatingReq* _this = reinterpret_cast< ChatingReq* >(object);
  (void)_this;
}
void ChatingReq::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void ChatingReq::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const ChatingReq& ChatingReq::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_ChatingReq_message_2eproto.base);
  return *internal_default_instance();
}


void ChatingReq::Clear() {
// @@protoc_insertion_point(message_clear_start:message.ChatingReq)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ChatingReq::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "message.ChatingReq.sender_name"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 sender_uid = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          sender_uid_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string recv_name = 3;
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          auto str = _internal_mutable_recv_name();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "message.ChatingReq.recv_name"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 recv_uid = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 32)) {
          recv_uid_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string content = 5;
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "message.ChatingReq.content"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* ChatingReq::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:message.ChatingReq)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->sender_name().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "message.ChatingReq.sender_name");
    target = stream->WriteStringMaybeAliased(
  ...
  if (this->sender_uid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->_internal_sender_uid(), target);
  }

  // string recv_name = 3;
  if (this->recv_name().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_recv_name().data(), static_cast<int>(this->_internal_recv_name().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "message.ChatingReq.recv_name");
    target = stream->WriteStringMaybeAliased(
        3, this->_internal_recv_name(), target);
  }

  // int32 recv_uid = 4;
  if (this->recv_uid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(4, this->_internal_recv_uid(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:message.ChatingReq)
  return target;
}

size_t ChatingReq::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:message.ChatingReq)
  size_t total_size = 0;
...
void ChatingReq::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:message.ChatingReq)
  GOOGLE_DCHECK_NE(&from, this);
  const ChatingReq* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ChatingReq>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:message.ChatingReq)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:message.ChatingReq)
    MergeFrom(*source);
  }
}

void ChatingReq::MergeFrom(const ChatingReq& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:message.ChatingReq)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from.recv_name().size() > 0) {
    _internal_set_recv_name(from._internal_recv_name());
  }
  ...
  if (from.recv_uid() != 0) {
    _internal_set_recv_uid(from._internal_recv_uid());
  }
}

void ChatingReq::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:message.ChatingReq)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void ChatingReq::CopyFrom(const ChatingReq& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:message.ChatingReq)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ChatingReq::IsInitialized() const {
  return true;
}

void ChatingReq::InternalSwap(ChatingReq* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  sender_name_.Swap(&other->sender_name_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  recv_name_.Swap(&other->recv_name_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  content_.Swap(&other->content_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ChatingReq, recv_uid_)
      + sizeof(ChatingReq::recv_uid_)
      - PROTOBUF_FIELD_OFFSET(ChatingReq, sender_uid_)>(
          reinterpret_cast<char*>(&sender_uid_),
          reinterpret_cast<char*>(&other->sender_uid_));
}

::PROTOBUF_NAMESPACE_ID::Metadata ChatingReq::GetMetadata() const {
  return GetMetadataStatic();
}
...
void ChatingRsp::InitAsDefaultInstance() {
}
class ChatingRsp::_Internal {
 public:
};

ChatingRsp::ChatingRsp(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:message.ChatingRsp)
}
ChatingRsp::ChatingRsp(const ChatingRsp& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ...
  error_ = from.error_;
  // @@protoc_insertion_point(copy_constructor:message.ChatingRsp)
}

void ChatingRsp::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ChatingRsp_message_2eproto.base);
  error_msg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  error_ = 0;
}

ChatingRsp::~ChatingRsp() {
  // @@protoc_insertion_point(destructor:message.ChatingRsp)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void ChatingRsp::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  error_msg_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void ChatingRsp::ArenaDtor(void* object) {
  ChatingRsp* _this = reinterpret_cast< ChatingRsp* >(object);
  (void)_this;
}
void ChatingRsp::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void ChatingRsp::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const ChatingRsp& ChatingRsp::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_ChatingRsp_message_2eproto.base);
  return *internal_default_instance();
}


void ChatingRsp::Clear() {
// @@protoc_insertion_point(message_clear_start:message.ChatingRsp)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ChatingRsp::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "message.ChatingRsp.error_msg"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* ChatingRsp::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:message.ChatingRsp)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:message.ChatingRsp)
  return target;
}

size_t ChatingRsp::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:message.ChatingRsp)
  size_t total_size = 0;
...
void ChatingRsp::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:message.ChatingRsp)
  GOOGLE_DCHECK_NE(&from, this);
  const ChatingRsp* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ChatingRsp>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:message.ChatingRsp)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:message.ChatingRsp)
    MergeFrom(*source);
  }
}

void ChatingRsp::MergeFrom(const ChatingRsp& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:message.ChatingRsp)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void ChatingRsp::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:message.ChatingRsp)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void ChatingRsp::CopyFrom(const ChatingRsp& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:message.ChatingRsp)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ChatingRsp::IsInitialized() const {
  return true;
}

void ChatingRsp::InternalSwap(ChatingRsp* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata ChatingRsp::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::message::ChatingReq* Arena::CreateMaybeMessage< ::message::ChatingReq >(Arena* arena) {
  return Arena::CreateMessageInternal< ::message::ChatingReq >(arena);
}
template<> PROTOBUF_NOINLINE ::message::ChatingRsp* Arena::CreateMaybeMessage< ::message::ChatingRsp >(Arena* arena) {
  return Arena::CreateMessageInternal< ::message::ChatingRsp >(arena);
}
